    ...
    (for ([j res2])
        (begin
            ...
            (if (equal? i j)
                (begin
                    ;; (printf "got it ~a ~a\n" i j)
                    (set! points (append (list i) points))
